...
//
    ...
    static void printList(ArrayList<Integer> list1,ArrayList<Integer> list2,
    ...
    static void printList(ArrayList<Integer> listName){
    ...
    public static void main(String[] args) {
        ...
        printList(listZadacha.generalList,listZadacha.listDeleniaNa3,listZadacha.listDeleniaNa2,listZadacha.otherList);
        printList(listZadacha.otherList);
    }
}
